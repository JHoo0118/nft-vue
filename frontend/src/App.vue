<template>
  <v-app app light>
    ...
    <router-link to="/" class="logo">
      <img src="./images/abc.png" height="80px" width="120px" />
    </router-link>
    <nav>
      <ul>
        <li>
        ...
        <li>
          <router-link class="router-a" to="/wallet">wallet</router-link>
        </li>
        <li>
          <router-link class="router-a" to="/upload">upload</router-link>
        </li>
      </ul>
    </nav>
    <svg
...
#decorator :first-child:hover,
#decorator :first-child:active {
  background: #816bff;
  color: #fff;
}

#decorator :first-child::before {
  content: "";
  width: 100%;
  display: block;
  position: absolute;
